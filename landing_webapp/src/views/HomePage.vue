<template>
  ...
  <script setup>
    ...
    const text2 = ref('УНИВЕРСАЛЬНОЕ')
    const text3 = ref('РЕШЕНИЕ')
    const text4 = ref('для')
    const text5 = ref('онлайн рекламы')
    const text6 = ref('ваших продуктов')
...
.image {
  width: 45px;
  height: auto;
  margin: 20px; /* Добавлено для отступа между изображением и текстом/кнопкой */
}
